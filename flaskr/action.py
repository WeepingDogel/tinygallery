...
def likeCheck():
    if request.method == "GET":
        ...
        # Get UUID value from Ajax Request by method GET.)
        postUUID = str(request.args.get("UUID"))
        # Get LikeStatus value from Ajax Request by method GET.
        LikeStatus = int(request.args.get("LikeStatus"))
        if postUUID == "":
            return "刷你妈呢", 403
